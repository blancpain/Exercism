...
int assemble_code() {
  return zhang::blue::code_fragment() + zhang::red::code_fragment() +
         khan::blue::code_fragment() + khan::red::code_fragment() +
         garcia::blue::code_fragment() + garcia::red::code_fragment();
}
} // namespace estate_executor
